          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 ">
            {statisticsData.map(({ label, value }) => (
              ...
              >
                ...
                <button className="bg-primary hover:bg-primary-dark text-white rounded-full py-2 px-6 mt-4 focus:outline-none transition-background-color duration-200 ease-in-out">
                  View Details
                </button>
              </div>
            ))}
